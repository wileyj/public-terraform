...
# resource "aws_iam_role_policy_attachment" "ops_snapshot" {
#   role       = "${aws_iam_role.ops_snapshot.name}"
#   policy_arn = "${aws_iam_policy.ops_snapshot.arn}"
#
#   depends_on = [
#     "aws_iam_role.ops_snapshot",
#     "aws_iam_policy.ops_snapshot",
#   ]
# }


# resource "aws_iam_role" "ops_snapshot" {
#   name               = "${var.org_name}.Ops.Snapshot"
